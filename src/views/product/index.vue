                ...
                <div class="col-12">
                  <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-grid" role="tabpanel"
                      ...
                      <div class="row">
                        <div v-for="product in productStore.products" class="col-xl-4 col-lg-6 col-6 ">
                          <div class="products-three-single w-100  mt-30">
                              ...
                              <div class="products-grid__usefull-links">
                                <ul>
                                  ...
                                  <li><a href="compare.html"> <i
                                    ...
                                    <span>
                                                                            compare</span> </a></li>
                                  <li><a @click="productStore.getProduct(product.id)" :href="`#popup${product.id}`" class="popup_link"> <i
                            ...
                            <div :id="`popup${product.id}`" class="product-gird__quick-view-popup mfp-hide">
                              <div v-if="productStore.popupProduct" class="container">
                                <div class="row justify-content-between align-items-center">
                                  <div class="col-lg-6">
                                    <div class="quick-view__left-content" v-if="productStore.popupProduct.images.length > 2">
                                      <div class="tabs">
                                        <div class="popup-product-thumb-box">
                                          <ul>
                                            <li v-for="image in productStore.popupProduct.images" class="tab-nav popup-product-thumb">
                                        ...
                                        <div class="popup-product-main-image-box">
                                          <div v-for="image_big in productStore.popupProduct.images" :id="`tabb${image_big.id}`"
                                               class="tab-item popup-product-image">
                                            <div
                                                class="popup-product-single-image">
                                              <img :src="image_big.url"
                                                   alt=""/></div>
                                          </div>
                                          <button class="prev"><i
                                  ...
                                  <div class="col-lg-6">
                                    <div class="popup-right-content">
                                      <h3>{{ productStore.popupProduct.title }}</h3>
                                      <div class="ratting"><i
                                        ...
                                        <i class="flaticon-star"></i> <i
                                            class="flaticon-star"></i>
                                        <span>(112)</span></div>
                                      <p class="text"> {{ productStore.popupProduct.description }}</p>
                                      <div class="price">
                                        <h2> {{productStore.popupProduct.price}} руб.
                                          <del> {{productStore.popupProduct.price_old}} руб.</del>
                                        </h2>
                                        <h6> In stuck</h6>
                                      </div>
                                      <div class="color-varient d-flex" style="gap: 5px">
                                        <template v-for="groupProduct in productStore.popupProduct.group_products">
                                            <a @click.prevent="productStore.getProduct(groupProduct.id)"  href="#" class="d-flex color-name" style="height: 40px; width: 40px;">
                            ...
                            <div class="products-three-single-content text-center">
                              ...
                              <p>
                                <del v-if="product.price_old != null" >{{product.price_old}}</del>
                                {{product.price}} руб.
                              </p>
                            </div>
                          </div>
